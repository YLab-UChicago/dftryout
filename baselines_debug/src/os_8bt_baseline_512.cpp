                ...
                for (int i = 0; i < filter_height; i++)
                    ...
                    for (int j = 0; j < filter_width; j++)
                        ...
                        if (input_h >= 0 && input_h < height && input_w >= 0 && input_w < width) {
                            ...
                            data2 = vld1q_u64_x4((const uint64_t*) &filters[f * filter_height * filter_width + i * filter_width + j]);
                            ...
                            sum_block += vaddvq_u8(vreinterpretq_u8_u64(data1.val[0])) + vaddvq_u8(vreinterpretq_u8_u64(data1.val[1]))+vaddvq_u8(vreinterpretq_u8_u64(data1.val[2]))+vaddvq_u8(vreinterpretq_u8_u64(data1.val[3]));
                        }
