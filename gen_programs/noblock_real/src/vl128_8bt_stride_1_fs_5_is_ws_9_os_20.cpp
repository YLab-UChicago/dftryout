        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                if (output_h >= 0 && output_h < out_height && output_w >= 0 && output_w < out_width) {
                    ...
                    outputs[output_h * out_width * num_filters + output_w * num_filters + f] += vaddvq_u8(output_cache_16);
                ...
                if (output_h >= 0 && output_h < out_height && output_w >= 0 && output_w < out_width) {
                    ...
                    data1 = vmulq_s8(input,data2);
                    output_cache_13 = vaddq_u8(output_cache_13,data1);
                    outputs[output_h * out_width * num_filters + output_w * num_filters + f] += vaddvq_u8(output_cache_13);
                ...
                if (output_h >= 0 && output_h < out_height && output_w >= 0 && output_w < out_width) {
                    ...
                    data1 = vmulq_s8(input,data2);
                    output_cache_17 = vaddq_u8(output_cache_17,data1);
                    outputs[output_h * out_width * num_filters + output_w * num_filters + f] += vaddvq_u8(output_cache_17);
                ...
                if (output_h >= 0 && output_h < out_height && output_w >= 0 && output_w < out_width) {
                    ...
                    data1 = vmulq_s8(input,data2);
                    output_cache_14 = vaddq_u8(output_cache_14,data1);
                    outputs[output_h * out_width * num_filters + output_w * num_filters + f] += vaddvq_u8(output_cache_14);
                ...
                if (output_h >= 0 && output_h < out_height && output_w >= 0 && output_w < out_width) {
                    ...
                    data1 = vmulq_s8(input,data2);
                    output_cache_18 = vaddq_u8(output_cache_18,data1);
                    outputs[output_h * out_width * num_filters + output_w * num_filters + f] += vaddvq_u8(output_cache_18);
                ...
                if (output_h >= 0 && output_h < out_height && output_w >= 0 && output_w < out_width) {
                    ...
                    data1 = vmulq_s8(input,data2);
                    output_cache_15 = vaddq_u8(output_cache_15,data1);
                    outputs[output_h * out_width * num_filters + output_w * num_filters + f] += vaddvq_u8(output_cache_15);
                ...
                if (output_h >= 0 && output_h < out_height && output_w >= 0 && output_w < out_width) {
                    ...
                    data1 = vmulq_s8(input,data2);
                    output_cache_19 = vaddq_u8(output_cache_19,data1);
                    outputs[output_h * out_width * num_filters + output_w * num_filters + f] += vaddvq_u8(output_cache_19);
