...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        input_cache_15 = vld1q_s64((const int64_t *) &inputs[(15 * width * depth /128 + 15) * 128 /64]);
        input_cache_16 = vld1q_s64((const int64_t *) &inputs[(16 * width * depth /128 + 16) * 128 /64]);
        input_cache_17 = vld1q_s64((const int64_t *) &inputs[(17 * width * depth /128 + 17) * 128 /64]);
        input_cache_18 = vld1q_s64((const int64_t *) &inputs[(18 * width * depth /128 + 18) * 128 /64]);
        input_cache_19 = vld1q_s64((const int64_t *) &inputs[(19 * width * depth /128 + 19) * 128 /64]);
