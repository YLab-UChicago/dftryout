...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        int64x2x4_t input_cache_3 = vld1q_s64_x4((const int64_t *) &inputs[(1 * width + 0) * 512 /64]);
        int64x2x4_t input_cache_4 = vld1q_s64_x4((const int64_t *) &inputs[(1 * width + 1) * 512 /64]);
        int i;
        int j;
