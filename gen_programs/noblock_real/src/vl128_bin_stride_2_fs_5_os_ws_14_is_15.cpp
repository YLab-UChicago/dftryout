...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        input_cache_12 = vld1q_s64((const int64_t *) &inputs[(12 * width * depth /128 + 12) * 128 /64]);
        input_cache_13 = vld1q_s64((const int64_t *) &inputs[(13 * width * depth /128 + 13) * 128 /64]);
        input_cache_14 = vld1q_s64((const int64_t *) &inputs[(14 * width * depth /128 + 14) * 128 /64]);
