    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_16)));
                ...
                data1 = veorq_s64(input,data2);
                output_cache_17 = vaddq_u8(output_cache_17,data1);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_17)));
                ...
                data1 = veorq_s64(input,data2);
                output_cache_18 = vaddq_u8(output_cache_18,data1);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_18)));
                ...
                data1 = veorq_s64(input,data2);
                output_cache_15 = vaddq_u8(output_cache_15,data1);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_15)));
                ...
                data1 = veorq_s64(input,data2);
                output_cache_19 = vaddq_u8(output_cache_19,data1);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_19)));
