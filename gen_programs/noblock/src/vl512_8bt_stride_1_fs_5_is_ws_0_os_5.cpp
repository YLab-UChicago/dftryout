    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_4.val[0])+vaddvq_u8(output_cache_4.val[1])+vaddvq_u8(output_cache_4.val[2])+vaddvq_u8(output_cache_4.val[3]);
                ...
                output_cache_3.val[2]= vaddq_u8(output_cache_3.val[2],data1.val[2]);
                output_cache_3.val[3]= vaddq_u8(output_cache_3.val[3],data1.val[3]);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_3.val[0])+vaddvq_u8(output_cache_3.val[1])+vaddvq_u8(output_cache_3.val[2])+vaddvq_u8(output_cache_3.val[3]);
