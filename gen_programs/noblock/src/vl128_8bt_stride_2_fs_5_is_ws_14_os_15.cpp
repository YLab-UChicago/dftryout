    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_3);
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_4);
                ...
                i = 3;
                j = 0;
                output_cache_3 = vmulq_s8(input,weight_cache_9);
                
                i = 2;
                j = 4;
                data1 = vmulq_s8(input,weight_cache_10);
                output_cache_6 = vaddq_u8(output_cache_6,data1);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_6);
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_7);
                ...
                i = 2;
                j = 1;
                output_cache_8 = vmulq_s8(input,weight_cache_13);
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_9);
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_10);
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_12);
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_13);
                ...
                data1 = vmulq_s8(input,weight_cache_6);
                output_cache_5 = vaddq_u8(output_cache_5,data1);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_5);
                ...
                i = 3;
                j = 1;
                output_cache_3 = vmulq_s8(input,weight_cache_8);
                ...
                data1 = vmulq_s8(input,weight_cache_11);
                output_cache_8 = vaddq_u8(output_cache_8,data1);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_8);
                ...
                i = 2;
                j = 1;
                output_cache_6 = vmulq_s8(input,weight_cache_13);
                ...
                data1 = vmulq_s8(input,data2);
                output_cache_11 = vaddq_u8(output_cache_11,data1);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_11);
                ...
                data1 = vmulq_s8(input,data2);
                output_cache_14 = vaddq_u8(output_cache_14,data1);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_14);
                ...
                i = 2;
                j = 1;
                output_cache_7 = vmulq_s8(input,weight_cache_13);
