    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < out_height; h++) {
            for (int w = 0; w < out_width; w ++) {
                ...
                data1 = veorq_s64(input_cache_2,weight_cache_6);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_4,weight_cache_10);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_5,weight_cache_11);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_7,weight_cache_15);
                output = vaddq_u8(output,vcntq_u8(data1));
