    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                i = 3;
                j = 0;
                output_cache_3 = veorq_s64(input,weight_cache_9);
                ...
                i = 2;
                j = 1;
                output_cache_8 = veorq_s64(input,weight_cache_13);
                ...
                i = 3;
                j = 1;
                output_cache_3 = veorq_s64(input,weight_cache_8);
                ...
                i = 2;
                j = 1;
                output_cache_6 = veorq_s64(input,weight_cache_13);
                ...
                i = 2;
                j = 1;
                output_cache_7 = veorq_s64(input,weight_cache_13);
