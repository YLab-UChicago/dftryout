...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        input_cache_6 = vld1q_s64((const int64_t *) &inputs[(6 * width * depth /128 + 6) * 128 /64]);
        input_cache_7 = vld1q_s64((const int64_t *) &inputs[(7 * width * depth /128 + 7) * 128 /64]);
        input_cache_8 = vld1q_s64((const int64_t *) &inputs[(8 * width * depth /128 + 8) * 128 /64]);
        input_cache_9 = vld1q_s64((const int64_t *) &inputs[(9 * width * depth /128 + 9) * 128 /64]);
        input_cache_10 = vld1q_s64((const int64_t *) &inputs[(10 * width * depth /128 + 10) * 128 /64]);
        input_cache_11 = vld1q_s64((const int64_t *) &inputs[(11 * width * depth /128 + 11) * 128 /64]);
        ...
        for (int h = 0; h < out_height; h++) {
            for (int w = 0; w < out_width; w ++) {
                ...
                data1 = vmulq_s8(input_cache_6,weight_cache_11);
                output = vaddq_u8(output,data1);
                ...
                i = 3;
                j = 2;
                data1 = vmulq_s8(input_cache_11,weight_cache_14);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_9,weight_cache_15);
                output = vaddq_u8(output,data1);
                ...
                i = 1;
                j = 0;
                data1 = vmulq_s8(input_cache_4,weight_cache_4);
                output = vaddq_u8(output,data1);
                ...
                i = 1;
                j = 2;
                data1 = vmulq_s8(input_cache_3,weight_cache_6);
                output = vaddq_u8(output,data1);
                ...
                i = 2;
                j = 1;
                data1 = vmulq_s8(input_cache_8,weight_cache_9);
                output = vaddq_u8(output,data1);
                
                i = 2;
                j = 2;
                data1 = vmulq_s8(input_cache_6,weight_cache_10);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_7,weight_cache_11);
                output = vaddq_u8(output,data1);
                ...
                i = 3;
                j = 1;
                data1 = vmulq_s8(input_cache_11,weight_cache_13);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_10,weight_cache_15);
                output = vaddq_u8(output,data1);
                ...
                i = 1;
                j = 0;
                data1 = vmulq_s8(input_cache_5,weight_cache_4);
                output = vaddq_u8(output,data1);
                ...
                i = 2;
                j = 0;
                data1 = vmulq_s8(input_cache_8,weight_cache_8);
                output = vaddq_u8(output,data1);
                ...
                i = 2;
                j = 2;
                data1 = vmulq_s8(input_cache_7,weight_cache_10);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_11,weight_cache_15);
                output = vaddq_u8(output,data1);
