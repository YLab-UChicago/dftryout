...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        input_cache_8 = vld1q_s64((const int64_t *) &inputs[(0 * width * depth /128 + 8) * 128 /64]);
        input_cache_9 = vld1q_s64((const int64_t *) &inputs[(0 * width * depth /128 + 9) * 128 /64]);
        input_cache_10 = vld1q_s64((const int64_t *) &inputs[(0 * width * depth /128 + 10) * 128 /64]);
        input_cache_11 = vld1q_s64((const int64_t *) &inputs[(0 * width * depth /128 + 11) * 128 /64]);
