...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        int64x2_t input_cache_3 = vld1q_s64((const int64_t *) &inputs[(1 * width + 0) * 128 /64]);
        int64x2_t input_cache_4 = vld1q_s64((const int64_t *) &inputs[(1 * width + 1) * 128 /64]);
        int64x2_t input_cache_5 = vld1q_s64((const int64_t *) &inputs[(1 * width + 2) * 128 /64]);
        int64x2_t input_cache_6 = vld1q_s64((const int64_t *) &inputs[(2 * width + 0) * 128 /64]);
        int64x2_t input_cache_7 = vld1q_s64((const int64_t *) &inputs[(2 * width + 1) * 128 /64]);
        int64x2_t input_cache_8 = vld1q_s64((const int64_t *) &inputs[(2 * width + 2) * 128 /64]);
        int64x2_t input_cache_9 = vld1q_s64((const int64_t *) &inputs[(3 * width + 0) * 128 /64]);
        int64x2_t input_cache_10 = vld1q_s64((const int64_t *) &inputs[(3 * width + 1) * 128 /64]);
        int64x2_t input_cache_11 = vld1q_s64((const int64_t *) &inputs[(3 * width + 2) * 128 /64]);
        int64x2_t input_cache_12 = vld1q_s64((const int64_t *) &inputs[(4 * width + 0) * 128 /64]);
        int64x2_t input_cache_13 = vld1q_s64((const int64_t *) &inputs[(4 * width + 1) * 128 /64]);
        int64x2_t input_cache_14 = vld1q_s64((const int64_t *) &inputs[(4 * width + 2) * 128 /64]);
        int64x2_t input_cache_15 = vld1q_s64((const int64_t *) &inputs[(5 * width + 0) * 128 /64]);
        int64x2_t input_cache_16 = vld1q_s64((const int64_t *) &inputs[(5 * width + 1) * 128 /64]);
        int64x2_t input_cache_17 = vld1q_s64((const int64_t *) &inputs[(5 * width + 2) * 128 /64]);
        int64x2_t input_cache_18 = vld1q_s64((const int64_t *) &inputs[(6 * width + 0) * 128 /64]);
        int64x2_t input_cache_19 = vld1q_s64((const int64_t *) &inputs[(6 * width + 1) * 128 /64]);
        int64x2_t input_cache_20 = vld1q_s64((const int64_t *) &inputs[(6 * width + 2) * 128 /64]);
        int64x2_t input_cache_21 = vld1q_s64((const int64_t *) &inputs[(7 * width + 0) * 128 /64]);
        int64x2_t input_cache_22 = vld1q_s64((const int64_t *) &inputs[(7 * width + 1) * 128 /64]);
        int64x2_t input_cache_23 = vld1q_s64((const int64_t *) &inputs[(7 * width + 2) * 128 /64]);
        int64x2_t input_cache_24 = vld1q_s64((const int64_t *) &inputs[(8 * width + 0) * 128 /64]);
        int64x2_t input_cache_25 = vld1q_s64((const int64_t *) &inputs[(8 * width + 1) * 128 /64]);
        int64x2_t input_cache_26 = vld1q_s64((const int64_t *) &inputs[(8 * width + 2) * 128 /64]);
        int64x2_t input_cache_27 = vld1q_s64((const int64_t *) &inputs[(9 * width + 0) * 128 /64]);
        int64x2_t input_cache_28 = vld1q_s64((const int64_t *) &inputs[(9 * width + 1) * 128 /64]);
        int i;
        int j;
