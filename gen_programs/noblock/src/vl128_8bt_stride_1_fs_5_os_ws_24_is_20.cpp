    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < out_height; h++) {
            for (int w = 0; w < out_width; w ++) {
                ...
                i = 3;
                j = 1;
                data1 = vmulq_s8(input_cache_13,weight_cache_16);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 2;
                data1 = vmulq_s8(input_cache_14,weight_cache_17);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 3;
                data1 = vmulq_s8(input_cache_15,weight_cache_18);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_12,weight_cache_19);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 0;
                data1 = vmulq_s8(input_cache_16,weight_cache_20);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 1;
                data1 = vmulq_s8(input_cache_17,weight_cache_21);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 2;
                data1 = vmulq_s8(input_cache_18,weight_cache_22);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 3;
                data1 = vmulq_s8(input_cache_19,weight_cache_23);
                output = vaddq_u8(output,data1);
                ...
                i = 3;
                j = 0;
                data1 = vmulq_s8(input_cache_13,weight_cache_15);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 1;
                data1 = vmulq_s8(input_cache_14,weight_cache_16);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 2;
                data1 = vmulq_s8(input_cache_15,weight_cache_17);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 3;
                data1 = vmulq_s8(input_cache_12,weight_cache_18);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_13,weight_cache_19);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 0;
                data1 = vmulq_s8(input_cache_17,weight_cache_20);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 1;
                data1 = vmulq_s8(input_cache_18,weight_cache_21);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 2;
                data1 = vmulq_s8(input_cache_19,weight_cache_22);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 3;
                data1 = vmulq_s8(input_cache_16,weight_cache_23);
                output = vaddq_u8(output,data1);
                ...
                i = 3;
                j = 0;
                data1 = vmulq_s8(input_cache_14,weight_cache_15);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 1;
                data1 = vmulq_s8(input_cache_15,weight_cache_16);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 2;
                data1 = vmulq_s8(input_cache_12,weight_cache_17);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 3;
                data1 = vmulq_s8(input_cache_13,weight_cache_18);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_14,weight_cache_19);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 0;
                data1 = vmulq_s8(input_cache_18,weight_cache_20);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 1;
                data1 = vmulq_s8(input_cache_19,weight_cache_21);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 2;
                data1 = vmulq_s8(input_cache_16,weight_cache_22);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 3;
                data1 = vmulq_s8(input_cache_17,weight_cache_23);
                output = vaddq_u8(output,data1);
                ...
                i = 3;
                j = 0;
                data1 = vmulq_s8(input_cache_15,weight_cache_15);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 1;
                data1 = vmulq_s8(input_cache_12,weight_cache_16);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 2;
                data1 = vmulq_s8(input_cache_13,weight_cache_17);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 3;
                data1 = vmulq_s8(input_cache_14,weight_cache_18);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_15,weight_cache_19);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 0;
                data1 = vmulq_s8(input_cache_19,weight_cache_20);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 1;
                data1 = vmulq_s8(input_cache_16,weight_cache_21);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 2;
                data1 = vmulq_s8(input_cache_17,weight_cache_22);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 3;
                data1 = vmulq_s8(input_cache_18,weight_cache_23);
                output = vaddq_u8(output,data1);
