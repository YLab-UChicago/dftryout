    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_8.val[0]))+vaddvq_u8(vcntq_u8(output_cache_8.val[1])));
                ...
                output_cache_9.val[0]= vaddq_u8(output_cache_9.val[0],data1.val[0]);
                output_cache_9.val[1]= vaddq_u8(output_cache_9.val[1],data1.val[1]);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_9.val[0]))+vaddvq_u8(vcntq_u8(output_cache_9.val[1])));
                ...
                output_cache_7.val[0]= vaddq_u8(output_cache_7.val[0],data1.val[0]);
                output_cache_7.val[1]= vaddq_u8(output_cache_7.val[1],data1.val[1]);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_7.val[0]))+vaddvq_u8(vcntq_u8(output_cache_7.val[1])));
