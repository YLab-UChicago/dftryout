...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        input_cache_12 = vld1q_s64((const int64_t *) &inputs[(0 * width * depth /128 + 12) * 128 /64]);
        input_cache_13 = vld1q_s64((const int64_t *) &inputs[(0 * width * depth /128 + 13) * 128 /64]);
        input_cache_14 = vld1q_s64((const int64_t *) &inputs[(0 * width * depth /128 + 14) * 128 /64]);
        ...
        for (int h = 0; h < out_height; h++) {
            for (int w = 0; w < out_width; w ++) {
                ...
                if (input_h >= 0 && input_h < height && input_w >= 0 && input_w < width) {
                    ...
                    data1 = vmulq_s8(input_cache_3,weight_cache_9);
                    output = vaddq_u8(output,data1);
                ...
                if (input_h >= 0 && input_h < height && input_w >= 0 && input_w < width) {
                    input_cache_3 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                    data1 = vmulq_s8(input_cache_3,weight_cache_8);
                    output = vaddq_u8(output,data1);
                ...
                if (input_h >= 0 && input_h < height && input_w >= 0 && input_w < width) {
                    input_cache_6 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                    data1 = vmulq_s8(input_cache_6,weight_cache_13);
                    output = vaddq_u8(output,data1);
                ...
                input_w = w * strides +2;
                if (input_h >= 0 && input_h < height && input_w >= 0 && input_w < width) {
                    data1 = vmulq_s8(input_cache_7,weight_cache_12);
                    output = vaddq_u8(output,data1);
