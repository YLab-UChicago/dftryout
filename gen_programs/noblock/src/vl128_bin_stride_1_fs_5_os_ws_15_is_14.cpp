    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < out_height; h++) {
            for (int w = 0; w < out_width; w ++) {
                ...
                i = 2;
                j = 1;
                data1 = veorq_s64(input_cache_9,weight_cache_11);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 2;
                data1 = veorq_s64(input_cache_10,weight_cache_12);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 3;
                data1 = veorq_s64(input_cache_11,weight_cache_13);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                i = 2;
                j = 0;
                data1 = veorq_s64(input_cache_9,weight_cache_10);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 1;
                data1 = veorq_s64(input_cache_10,weight_cache_11);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 2;
                data1 = veorq_s64(input_cache_11,weight_cache_12);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_9,weight_cache_14);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                i = 2;
                j = 0;
                data1 = veorq_s64(input_cache_10,weight_cache_10);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 1;
                data1 = veorq_s64(input_cache_11,weight_cache_11);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                i = 2;
                j = 3;
                data1 = veorq_s64(input_cache_9,weight_cache_13);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_10,weight_cache_14);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_7,weight_cache_9);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 0;
                data1 = veorq_s64(input_cache_11,weight_cache_10);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                i = 2;
                j = 2;
                data1 = veorq_s64(input_cache_9,weight_cache_12);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 3;
                data1 = veorq_s64(input_cache_10,weight_cache_13);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_11,weight_cache_14);
                output = vaddq_u8(output,vcntq_u8(data1));
