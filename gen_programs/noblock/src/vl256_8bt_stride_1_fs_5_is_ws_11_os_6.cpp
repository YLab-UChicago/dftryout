    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                i = 3;
                j = 2;
                output_cache_4.val[0] = vmulq_s8(input.val[0],weight_cache_7.val[0]);
                output_cache_4.val[1] = vmulq_s8(input.val[1],weight_cache_7.val[1]);
                outputs[h * out_width * num_filters + w * num_filters + f] += vaddvq_u8(output_cache_4.val[0])+vaddvq_u8(output_cache_4.val[1]);
                
                
                i = 3;
                j = 1;
                output_cache_5.val[0] = vmulq_s8(input.val[0],weight_cache_8.val[0]);
                output_cache_5.val[1] = vmulq_s8(input.val[1],weight_cache_8.val[1]);
                ...
                i = 3;
                j = 2;
                output_cache_5.val[0] = vmulq_s8(input.val[0],weight_cache_7.val[0]);
                output_cache_5.val[1] = vmulq_s8(input.val[1],weight_cache_7.val[1]);
                outputs[h * out_width * num_filters + w * num_filters + f] += vaddvq_u8(output_cache_5.val[0])+vaddvq_u8(output_cache_5.val[1]);
                
                
                i = 3;
                j = 1;
                output_cache_6.val[0] = vmulq_s8(input.val[0],weight_cache_8.val[0]);
                output_cache_6.val[1] = vmulq_s8(input.val[1],weight_cache_8.val[1]);
                ...
                i = 3;
                j = 2;
                output_cache_6.val[0] = vmulq_s8(input.val[0],weight_cache_7.val[0]);
                output_cache_6.val[1] = vmulq_s8(input.val[1],weight_cache_7.val[1]);
                outputs[h * out_width * num_filters + w * num_filters + f] += vaddvq_u8(output_cache_6.val[0])+vaddvq_u8(output_cache_6.val[1]);
                
                
                i = 3;
                j = 1;
                output_cache_7.val[0] = vmulq_s8(input.val[0],weight_cache_8.val[0]);
                output_cache_7.val[1] = vmulq_s8(input.val[1],weight_cache_8.val[1]);
                ...
                i = 3;
                j = 2;
                output_cache_7.val[0] = vmulq_s8(input.val[0],weight_cache_7.val[0]);
                output_cache_7.val[1] = vmulq_s8(input.val[1],weight_cache_7.val[1]);
                outputs[h * out_width * num_filters + w * num_filters + f] += vaddvq_u8(output_cache_7.val[0])+vaddvq_u8(output_cache_7.val[1]);
                
                
                i = 3;
                j = 1;
                output_cache_4.val[0] = vmulq_s8(input.val[0],weight_cache_8.val[0]);
                output_cache_4.val[1] = vmulq_s8(input.val[1],weight_cache_8.val[1]);
                outputs[h * out_width * num_filters + w * num_filters + f] += vaddvq_u8(output_cache_4.val[0])+vaddvq_u8(output_cache_4.val[1]);
