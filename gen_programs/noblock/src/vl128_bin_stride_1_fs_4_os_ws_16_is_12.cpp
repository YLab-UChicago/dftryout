    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < out_height; h++) {
            for (int w = 0; w < out_width; w ++) {
                ...
                i = 1;
                j = 0;
                data1 = veorq_s64(input_cache_4,weight_cache_4);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                i = 2;
                j = 1;
                data1 = veorq_s64(input_cache_8,weight_cache_9);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                i = 1;
                j = 0;
                data1 = veorq_s64(input_cache_5,weight_cache_4);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                i = 2;
                j = 0;
                data1 = veorq_s64(input_cache_8,weight_cache_8);
                output = vaddq_u8(output,vcntq_u8(data1));
