    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                i = 2;
                j = 1;
                output_cache_0.val[0] = vmulq_s8(input.val[0],weight_cache_1.val[0]);
                output_cache_0.val[1] = vmulq_s8(input.val[1],weight_cache_1.val[1]);
                output_cache_0.val[2] = vmulq_s8(input.val[2],weight_cache_1.val[2]);
                output_cache_0.val[3] = vmulq_s8(input.val[3],weight_cache_1.val[3]);
