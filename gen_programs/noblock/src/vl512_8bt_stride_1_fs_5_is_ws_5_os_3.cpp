    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                output_cache_1.val[2] = vmulq_s8(input.val[2],weight_cache_4.val[2]);
                output_cache_1.val[3] = vmulq_s8(input.val[3],weight_cache_4.val[3]);
                ...
                output_cache_2.val[2] = vmulq_s8(input.val[2],weight_cache_4.val[2]);
                output_cache_2.val[3] = vmulq_s8(input.val[3],weight_cache_4.val[3]);
                ...
                output_cache_3.val[2] = vmulq_s8(input.val[2],weight_cache_4.val[2]);
                output_cache_3.val[3] = vmulq_s8(input.val[3],weight_cache_4.val[3]);
                ...
                output_cache_0.val[2] = vmulq_s8(input.val[2],weight_cache_4.val[2]);
                output_cache_0.val[3] = vmulq_s8(input.val[3],weight_cache_4.val[3]);
                outputs[h * out_width * num_filters + w * num_filters + f] += vaddvq_u8(output_cache_0.val[0])+vaddvq_u8(output_cache_0.val[1])+vaddvq_u8(output_cache_0.val[2])+vaddvq_u8(output_cache_0.val[3]);
