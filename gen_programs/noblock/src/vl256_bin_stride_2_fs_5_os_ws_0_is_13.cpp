...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        input_cache_1 = vld1q_s64_x2((const int64_t *) &inputs[(0 * width * depth /256 + 1) * 256 /64]);
        input_cache_2 = vld1q_s64_x2((const int64_t *) &inputs[(0 * width * depth /256 + 2) * 256 /64]);
        input_cache_3 = vld1q_s64_x2((const int64_t *) &inputs[(0 * width * depth /256 + 3) * 256 /64]);
        input_cache_4 = vld1q_s64_x2((const int64_t *) &inputs[(0 * width * depth /256 + 4) * 256 /64]);
        input_cache_5 = vld1q_s64_x2((const int64_t *) &inputs[(0 * width * depth /256 + 5) * 256 /64]);
        input_cache_6 = vld1q_s64_x2((const int64_t *) &inputs[(0 * width * depth /256 + 6) * 256 /64]);
        input_cache_7 = vld1q_s64_x2((const int64_t *) &inputs[(0 * width * depth /256 + 7) * 256 /64]);
        input_cache_8 = vld1q_s64_x2((const int64_t *) &inputs[(0 * width * depth /256 + 8) * 256 /64]);
        input_cache_9 = vld1q_s64_x2((const int64_t *) &inputs[(0 * width * depth /256 + 9) * 256 /64]);
        input_cache_10 = vld1q_s64_x2((const int64_t *) &inputs[(0 * width * depth /256 + 10) * 256 /64]);
        input_cache_11 = vld1q_s64_x2((const int64_t *) &inputs[(0 * width * depth /256 + 11) * 256 /64]);
        input_cache_12 = vld1q_s64_x2((const int64_t *) &inputs[(0 * width * depth /256 + 12) * 256 /64]);
        int64x2x2_t output;
