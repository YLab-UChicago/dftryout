    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                output_h = floor((h - i) / strides);
                output_w = floor((w - j) / strides);
                output_cache_2.val[0] = vmulq_s8(input.val[0],weight_cache_5.val[0]);
                output_cache_2.val[1] = vmulq_s8(input.val[1],weight_cache_5.val[1]);
                ...
                output_h = floor((h - i) / strides);
                output_w = floor((w - j) / strides);
                output_cache_3.val[0] = vmulq_s8(input.val[0],weight_cache_5.val[0]);
                output_cache_3.val[1] = vmulq_s8(input.val[1],weight_cache_5.val[1]);
