    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_0.val[0])+vaddvq_u8(output_cache_0.val[1]);
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_4.val[0])+vaddvq_u8(output_cache_4.val[1]);
                ...
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_8.val[0])+vaddvq_u8(output_cache_8.val[1]);
                ...
                data1.val[0] = vmulq_s8(input.val[0],data2.val[0]);
                data1.val[1] = vmulq_s8(input.val[1],data2.val[1]);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(data1.val[0])+vaddvq_u8(data1.val[1]);
                ...
                output_cache_1.val[0]= vaddq_u8(output_cache_1.val[0],data1.val[0]);
                output_cache_1.val[1]= vaddq_u8(output_cache_1.val[1],data1.val[1]);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_1.val[0])+vaddvq_u8(output_cache_1.val[1]);
                ...
                output_cache_5.val[0]= vaddq_u8(output_cache_5.val[0],data1.val[0]);
                output_cache_5.val[1]= vaddq_u8(output_cache_5.val[1],data1.val[1]);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_5.val[0])+vaddvq_u8(output_cache_5.val[1]);
                ...
                output_cache_9.val[0]= vaddq_u8(output_cache_9.val[0],data1.val[0]);
                output_cache_9.val[1]= vaddq_u8(output_cache_9.val[1],data1.val[1]);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_9.val[0])+vaddvq_u8(output_cache_9.val[1]);
                ...
                output_cache_2.val[0]= vaddq_u8(output_cache_2.val[0],data1.val[0]);
                output_cache_2.val[1]= vaddq_u8(output_cache_2.val[1],data1.val[1]);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_2.val[0])+vaddvq_u8(output_cache_2.val[1]);
                ...
                output_cache_6.val[0]= vaddq_u8(output_cache_6.val[0],data1.val[0]);
                output_cache_6.val[1]= vaddq_u8(output_cache_6.val[1],data1.val[1]);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_6.val[0])+vaddvq_u8(output_cache_6.val[1]);
                ...
                output_cache_3.val[0]= vaddq_u8(output_cache_3.val[0],data1.val[0]);
                output_cache_3.val[1]= vaddq_u8(output_cache_3.val[1],data1.val[1]);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_3.val[0])+vaddvq_u8(output_cache_3.val[1]);
                ...
                output_cache_7.val[0]= vaddq_u8(output_cache_7.val[0],data1.val[0]);
                output_cache_7.val[1]= vaddq_u8(output_cache_7.val[1],data1.val[1]);
                outputs[output_h * out_width * num_filters + out_w * num_filters + f] += vaddvq_u8(output_cache_7.val[0])+vaddvq_u8(output_cache_7.val[1]);
