    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < out_height; h++) {
            for (int w = 0; w < out_width; w ++) {
                ...
                data1 = vmulq_s8(input_cache_8,weight_cache_13);
                output = vaddq_u8(output,data1);
                ...
                input_h = h * strides +2;
                input_w = w * strides +4;
                data1 = vmulq_s8(input_cache_8,weight_cache_14);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_9,weight_cache_13);
                output = vaddq_u8(output,data1);
                ...
                input_h = h * strides +2;
                input_w = w * strides +4;
                data1 = vmulq_s8(input_cache_9,weight_cache_14);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_10,weight_cache_13);
                output = vaddq_u8(output,data1);
                ...
                input_h = h * strides +2;
                input_w = w * strides +4;
                data1 = vmulq_s8(input_cache_10,weight_cache_14);
                output = vaddq_u8(output,data1);
