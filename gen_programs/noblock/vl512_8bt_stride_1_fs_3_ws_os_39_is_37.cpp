...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        output_cache_38.val[2] = vaddq_u8(output_cache_38.val[2],data1.val[2]);
        output_cache_38.val[3] = vaddq_u8(output_cache_38.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += vaddvq_u8(output_cache_38.val[0])+vaddvq_u8(output_cache_38.val[1])+vaddvq_u8(output_cache_38.val[2])+vaddvq_u8(output_cache_38.val[3]);
