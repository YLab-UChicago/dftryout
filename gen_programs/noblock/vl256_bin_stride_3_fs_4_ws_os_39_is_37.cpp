    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (i = 0; i < filter_height - 1; i ++) {
            for (j = 0; j < filter_width; j ++) {
                ...
                input_h = h * strides + i - padding;
                input_w = w * strides + j - padding;
                data1 = vld1q_s64_x2((const int64_t*)& filters[(f * filter_height * filter_width + i * filter_width + j)*256/64]);
        ...
        output_cache_38.val[0] = vaddq_u8(output_cache_38.val[0],data1.val[0]);
        output_cache_38.val[1] = vaddq_u8(output_cache_38.val[1],data1.val[1]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_38.val[0]))+vaddvq_u8(vcntq_u8(output_cache_38.val[1])));
