...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        int64x2x4_t input_cache_12 = vld1q_s64_x4((const int64_t *) &inputs[((2-padding) * width * depth /256 + (2-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_13 = vld1q_s64_x4((const int64_t *) &inputs[((2-padding) * width * depth /256 + (3-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_14 = vld1q_s64_x4((const int64_t *) &inputs[((2-padding) * width * depth /256 + (4-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_15 = vld1q_s64_x4((const int64_t *) &inputs[((3-padding) * width * depth /256 + (0-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_16 = vld1q_s64_x4((const int64_t *) &inputs[((3-padding) * width * depth /256 + (1-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_17 = vld1q_s64_x4((const int64_t *) &inputs[((3-padding) * width * depth /256 + (2-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_18 = vld1q_s64_x4((const int64_t *) &inputs[((3-padding) * width * depth /256 + (3-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_19 = vld1q_s64_x4((const int64_t *) &inputs[((3-padding) * width * depth /256 + (4-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_20 = vld1q_s64_x4((const int64_t *) &inputs[((4-padding) * width * depth /256 + (0-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_21 = vld1q_s64_x4((const int64_t *) &inputs[((4-padding) * width * depth /256 + (1-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_22 = vld1q_s64_x4((const int64_t *) &inputs[((4-padding) * width * depth /256 + (2-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_23 = vld1q_s64_x4((const int64_t *) &inputs[((4-padding) * width * depth /256 + (3-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_24 = vld1q_s64_x4((const int64_t *) &inputs[((4-padding) * width * depth /256 + (4-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_25 = vld1q_s64_x4((const int64_t *) &inputs[((5-padding) * width * depth /256 + (0-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_26 = vld1q_s64_x4((const int64_t *) &inputs[((5-padding) * width * depth /256 + (1-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_27 = vld1q_s64_x4((const int64_t *) &inputs[((5-padding) * width * depth /256 + (2-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_28 = vld1q_s64_x4((const int64_t *) &inputs[((5-padding) * width * depth /256 + (3-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_29 = vld1q_s64_x4((const int64_t *) &inputs[((5-padding) * width * depth /256 + (4-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_30 = vld1q_s64_x4((const int64_t *) &inputs[((6-padding) * width * depth /256 + (0-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_31 = vld1q_s64_x4((const int64_t *) &inputs[((6-padding) * width * depth /256 + (1-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_32 = vld1q_s64_x4((const int64_t *) &inputs[((6-padding) * width * depth /256 + (2-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_33 = vld1q_s64_x4((const int64_t *) &inputs[((6-padding) * width * depth /256 + (3-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_34 = vld1q_s64_x4((const int64_t *) &inputs[((6-padding) * width * depth /256 + (4-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_35 = vld1q_s64_x4((const int64_t *) &inputs[((7-padding) * width * depth /256 + (0-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_36 = vld1q_s64_x4((const int64_t *) &inputs[((7-padding) * width * depth /256 + (1-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_37 = vld1q_s64_x4((const int64_t *) &inputs[((7-padding) * width * depth /256 + (2-padding) * depth /256) * 512 /64]);
        int64x2x4_t input_cache_38 = vld1q_s64_x4((const int64_t *) &inputs[((7-padding) * width * depth /256 + (3-padding) * depth /256) * 512 /64]);
        int i;
        int j;
