...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        output_cache_37.val[0] = vaddq_u8(output_cache_37.val[0],data1.val[0]);
        output_cache_37.val[1] = vaddq_u8(output_cache_37.val[1],data1.val[1]);
        outputs[h * out_width * num_filters + w * num_filters + f] += vaddvq_u8(output_cache_37.val[0])+vaddvq_u8(output_cache_37.val[1]);
        ...
        output_cache_38.val[0] = vaddq_u8(output_cache_38.val[0],data1.val[0]);
        output_cache_38.val[1] = vaddq_u8(output_cache_38.val[1],data1.val[1]);
        outputs[h * out_width * num_filters + w * num_filters + f] += vaddvq_u8(output_cache_38.val[0])+vaddvq_u8(output_cache_38.val[1]);
