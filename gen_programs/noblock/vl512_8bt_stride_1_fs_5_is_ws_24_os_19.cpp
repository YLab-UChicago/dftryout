    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                data1.val[2] = vmulq_s8(input.val[2],weight_cache_14.val[2]);
                data1.val[3] = vmulq_s8(input.val[3],weight_cache_14.val[3]);
                ...
                data1.val[2] = vmulq_s8(input.val[2],weight_cache_15.val[2]);
                data1.val[3] = vmulq_s8(input.val[3],weight_cache_15.val[3]);
                ...
                data1.val[2] = vmulq_s8(input.val[2],weight_cache_16.val[2]);
                data1.val[3] = vmulq_s8(input.val[3],weight_cache_16.val[3]);
                ...
                data1.val[2] = vmulq_s8(input.val[2],weight_cache_17.val[2]);
                data1.val[3] = vmulq_s8(input.val[3],weight_cache_17.val[3]);
                ...
                data1.val[2] = vmulq_s8(input.val[2],weight_cache_18.val[2]);
                data1.val[3] = vmulq_s8(input.val[3],weight_cache_18.val[3]);
                ...
                data1.val[2] = vmulq_s8(input.val[2],weight_cache_19.val[2]);
                data1.val[3] = vmulq_s8(input.val[3],weight_cache_19.val[3]);
                ...
                data1.val[2] = vmulq_s8(input.val[2],weight_cache_20.val[2]);
                data1.val[3] = vmulq_s8(input.val[3],weight_cache_20.val[3]);
                ...
                data1.val[2] = vmulq_s8(input.val[2],weight_cache_21.val[2]);
                data1.val[3] = vmulq_s8(input.val[3],weight_cache_21.val[3]);
                ...
                data1.val[2] = vmulq_s8(input.val[2],weight_cache_22.val[2]);
                data1.val[3] = vmulq_s8(input.val[3],weight_cache_22.val[3]);
                ...
                data1.val[2] = vmulq_s8(input.val[2],weight_cache_23.val[2]);
                data1.val[3] = vmulq_s8(input.val[3],weight_cache_23.val[3]);
