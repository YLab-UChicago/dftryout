    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                data1.val[2] = veorq_s64(input.val[2],weight_cache_3.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_3.val[3]);
                ...
                data1.val[2] = veorq_s64(input.val[2],weight_cache_4.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_4.val[3]);
                ...
                i = 3;
                j = 4;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_5.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_5.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_5.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_5.val[3]);
                ...
                data1.val[1] = veorq_s64(input.val[1],weight_cache_6.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_6.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_6.val[3]);
                ...
                data1.val[1] = veorq_s64(input.val[1],weight_cache_7.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_7.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_7.val[3]);
                ...
                data1.val[1] = veorq_s64(input.val[1],weight_cache_8.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_8.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_8.val[3]);
                ...
                i = 3;
                j = 0;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_9.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_9.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_9.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_9.val[3]);
                ...
                i = 2;
                j = 4;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_10.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_10.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_10.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_10.val[3]);
                ...
                i = 2;
                j = 3;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_11.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_11.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_11.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_11.val[3]);
                ...
                i = 2;
                j = 2;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_12.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_12.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_12.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_12.val[3]);
                ...
                i = 2;
                j = 1;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_13.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_13.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_13.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_13.val[3]);
                ...
                i = 2;
                j = 0;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_14.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_14.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_14.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_14.val[3]);
                ...
                i = 1;
                j = 4;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_15.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_15.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_15.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_15.val[3]);
                ...
                i = 1;
                j = 3;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_16.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_16.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_16.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_16.val[3]);
                ...
                i = 1;
                j = 2;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_17.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_17.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_17.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_17.val[3]);
                ...
                i = 1;
                j = 1;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_18.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_18.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_18.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_18.val[3]);
                ...
                i = 1;
                j = 0;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_19.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_19.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_19.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_19.val[3]);
                ...
                i = 0;
                j = 4;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_20.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_20.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_20.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_20.val[3]);
                ...
                i = 0;
                j = 3;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_21.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_21.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_21.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_21.val[3]);
                ...
                i = 0;
                j = 2;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_22.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_22.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_22.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_22.val[3]);
                output_cache_16.val[0] = data1.val[0];
                output_cache_16.val[1] = data1.val[1];
                output_cache_16.val[2] = data1.val[2];
                output_cache_16.val[3] = data1.val[3];
                
                i = 0;
                j = 1;
                data1.val[0] = veorq_s64(input.val[0],weight_cache_23.val[0]);
                data1.val[1] = veorq_s64(input.val[1],weight_cache_23.val[1]);
                data1.val[2] = veorq_s64(input.val[2],weight_cache_23.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_23.val[3]);
                output_cache_17.val[0] = data1.val[0];
                output_cache_17.val[1] = data1.val[1];
                output_cache_17.val[2] = data1.val[2];
                output_cache_17.val[3] = data1.val[3];
                ...
                data1.val[2] = veorq_s64(input.val[2],weight_cache_23.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_23.val[3]);
                output_cache_18.val[0] = data1.val[0];
                output_cache_18.val[1] = data1.val[1];
                output_cache_18.val[2] = data1.val[2];
                output_cache_18.val[3] = data1.val[3];
                ...
                data1.val[2] = veorq_s64(input.val[2],weight_cache_23.val[2]);
                data1.val[3] = veorq_s64(input.val[3],weight_cache_23.val[3]);
                output_cache_19.val[0] = data1.val[0];
                output_cache_19.val[1] = data1.val[1];
                output_cache_19.val[2] = data1.val[2];
                output_cache_19.val[3] = data1.val[3];
