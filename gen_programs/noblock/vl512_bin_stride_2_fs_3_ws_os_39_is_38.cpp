...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        output_cache_38.val[0]=vdupq_n_u64(0);
        output_cache_38.val[1]=vdupq_n_u64(0);
        output_cache_38.val[2]=vdupq_n_u64(0);
        output_cache_38.val[3]=vdupq_n_u64(0);
        ...
        for (i = 0; i < filter_height - 1; i ++) {
            for (j = 0; j < filter_width; j ++) {
                ...
                output_cache_38.val[0] = vaddq_u8(output_cache_38.val[0],data1.val[0]);
                output_cache_38.val[1] = vaddq_u8(output_cache_38.val[1],data1.val[1]);
                output_cache_38.val[2] = vaddq_u8(output_cache_38.val[2],data1.val[2]);
                output_cache_38.val[3] = vaddq_u8(output_cache_38.val[3],data1.val[3]);
        ...
        output_cache_7.val[2] = vaddq_u8(output_cache_7.val[2],data1.val[2]);
        output_cache_7.val[3] = vaddq_u8(output_cache_7.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_7.val[0]))+vaddvq_u8(vcntq_u8(output_cache_7.val[1]))+vaddvq_u8(vcntq_u8(output_cache_7.val[2]))+vaddvq_u8(vcntq_u8(output_cache_7.val[3])));
        ...
        output_cache_8.val[2] = vaddq_u8(output_cache_8.val[2],data1.val[2]);
        output_cache_8.val[3] = vaddq_u8(output_cache_8.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_8.val[0]))+vaddvq_u8(vcntq_u8(output_cache_8.val[1]))+vaddvq_u8(vcntq_u8(output_cache_8.val[2]))+vaddvq_u8(vcntq_u8(output_cache_8.val[3])));
        ...
        output_cache_9.val[2] = vaddq_u8(output_cache_9.val[2],data1.val[2]);
        output_cache_9.val[3] = vaddq_u8(output_cache_9.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_9.val[0]))+vaddvq_u8(vcntq_u8(output_cache_9.val[1]))+vaddvq_u8(vcntq_u8(output_cache_9.val[2]))+vaddvq_u8(vcntq_u8(output_cache_9.val[3])));
        ...
        output_cache_10.val[2] = vaddq_u8(output_cache_10.val[2],data1.val[2]);
        output_cache_10.val[3] = vaddq_u8(output_cache_10.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_10.val[0]))+vaddvq_u8(vcntq_u8(output_cache_10.val[1]))+vaddvq_u8(vcntq_u8(output_cache_10.val[2]))+vaddvq_u8(vcntq_u8(output_cache_10.val[3])));
        ...
        output_cache_11.val[2] = vaddq_u8(output_cache_11.val[2],data1.val[2]);
        output_cache_11.val[3] = vaddq_u8(output_cache_11.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_11.val[0]))+vaddvq_u8(vcntq_u8(output_cache_11.val[1]))+vaddvq_u8(vcntq_u8(output_cache_11.val[2]))+vaddvq_u8(vcntq_u8(output_cache_11.val[3])));
        ...
        output_cache_12.val[2] = vaddq_u8(output_cache_12.val[2],data1.val[2]);
        output_cache_12.val[3] = vaddq_u8(output_cache_12.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_12.val[0]))+vaddvq_u8(vcntq_u8(output_cache_12.val[1]))+vaddvq_u8(vcntq_u8(output_cache_12.val[2]))+vaddvq_u8(vcntq_u8(output_cache_12.val[3])));
        ...
        output_cache_13.val[2] = vaddq_u8(output_cache_13.val[2],data1.val[2]);
        output_cache_13.val[3] = vaddq_u8(output_cache_13.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_13.val[0]))+vaddvq_u8(vcntq_u8(output_cache_13.val[1]))+vaddvq_u8(vcntq_u8(output_cache_13.val[2]))+vaddvq_u8(vcntq_u8(output_cache_13.val[3])));
        ...
        output_cache_14.val[2] = vaddq_u8(output_cache_14.val[2],data1.val[2]);
        output_cache_14.val[3] = vaddq_u8(output_cache_14.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_14.val[0]))+vaddvq_u8(vcntq_u8(output_cache_14.val[1]))+vaddvq_u8(vcntq_u8(output_cache_14.val[2]))+vaddvq_u8(vcntq_u8(output_cache_14.val[3])));
        ...
        output_cache_15.val[2] = vaddq_u8(output_cache_15.val[2],data1.val[2]);
        output_cache_15.val[3] = vaddq_u8(output_cache_15.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_15.val[0]))+vaddvq_u8(vcntq_u8(output_cache_15.val[1]))+vaddvq_u8(vcntq_u8(output_cache_15.val[2]))+vaddvq_u8(vcntq_u8(output_cache_15.val[3])));
        ...
        output_cache_16.val[2] = vaddq_u8(output_cache_16.val[2],data1.val[2]);
        output_cache_16.val[3] = vaddq_u8(output_cache_16.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_16.val[0]))+vaddvq_u8(vcntq_u8(output_cache_16.val[1]))+vaddvq_u8(vcntq_u8(output_cache_16.val[2]))+vaddvq_u8(vcntq_u8(output_cache_16.val[3])));
        ...
        output_cache_17.val[2] = vaddq_u8(output_cache_17.val[2],data1.val[2]);
        output_cache_17.val[3] = vaddq_u8(output_cache_17.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_17.val[0]))+vaddvq_u8(vcntq_u8(output_cache_17.val[1]))+vaddvq_u8(vcntq_u8(output_cache_17.val[2]))+vaddvq_u8(vcntq_u8(output_cache_17.val[3])));
        ...
        output_cache_18.val[2] = vaddq_u8(output_cache_18.val[2],data1.val[2]);
        output_cache_18.val[3] = vaddq_u8(output_cache_18.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_18.val[0]))+vaddvq_u8(vcntq_u8(output_cache_18.val[1]))+vaddvq_u8(vcntq_u8(output_cache_18.val[2]))+vaddvq_u8(vcntq_u8(output_cache_18.val[3])));
        ...
        output_cache_19.val[2] = vaddq_u8(output_cache_19.val[2],data1.val[2]);
        output_cache_19.val[3] = vaddq_u8(output_cache_19.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_19.val[0]))+vaddvq_u8(vcntq_u8(output_cache_19.val[1]))+vaddvq_u8(vcntq_u8(output_cache_19.val[2]))+vaddvq_u8(vcntq_u8(output_cache_19.val[3])));
        ...
        output_cache_20.val[2] = vaddq_u8(output_cache_20.val[2],data1.val[2]);
        output_cache_20.val[3] = vaddq_u8(output_cache_20.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_20.val[0]))+vaddvq_u8(vcntq_u8(output_cache_20.val[1]))+vaddvq_u8(vcntq_u8(output_cache_20.val[2]))+vaddvq_u8(vcntq_u8(output_cache_20.val[3])));
        ...
        output_cache_21.val[2] = vaddq_u8(output_cache_21.val[2],data1.val[2]);
        output_cache_21.val[3] = vaddq_u8(output_cache_21.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_21.val[0]))+vaddvq_u8(vcntq_u8(output_cache_21.val[1]))+vaddvq_u8(vcntq_u8(output_cache_21.val[2]))+vaddvq_u8(vcntq_u8(output_cache_21.val[3])));
        ...
        output_cache_22.val[2] = vaddq_u8(output_cache_22.val[2],data1.val[2]);
        output_cache_22.val[3] = vaddq_u8(output_cache_22.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_22.val[0]))+vaddvq_u8(vcntq_u8(output_cache_22.val[1]))+vaddvq_u8(vcntq_u8(output_cache_22.val[2]))+vaddvq_u8(vcntq_u8(output_cache_22.val[3])));
        ...
        output_cache_23.val[2] = vaddq_u8(output_cache_23.val[2],data1.val[2]);
        output_cache_23.val[3] = vaddq_u8(output_cache_23.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_23.val[0]))+vaddvq_u8(vcntq_u8(output_cache_23.val[1]))+vaddvq_u8(vcntq_u8(output_cache_23.val[2]))+vaddvq_u8(vcntq_u8(output_cache_23.val[3])));
        ...
        output_cache_24.val[2] = vaddq_u8(output_cache_24.val[2],data1.val[2]);
        output_cache_24.val[3] = vaddq_u8(output_cache_24.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_24.val[0]))+vaddvq_u8(vcntq_u8(output_cache_24.val[1]))+vaddvq_u8(vcntq_u8(output_cache_24.val[2]))+vaddvq_u8(vcntq_u8(output_cache_24.val[3])));
        ...
        output_cache_25.val[2] = vaddq_u8(output_cache_25.val[2],data1.val[2]);
        output_cache_25.val[3] = vaddq_u8(output_cache_25.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_25.val[0]))+vaddvq_u8(vcntq_u8(output_cache_25.val[1]))+vaddvq_u8(vcntq_u8(output_cache_25.val[2]))+vaddvq_u8(vcntq_u8(output_cache_25.val[3])));
        ...
        output_cache_26.val[2] = vaddq_u8(output_cache_26.val[2],data1.val[2]);
        output_cache_26.val[3] = vaddq_u8(output_cache_26.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_26.val[0]))+vaddvq_u8(vcntq_u8(output_cache_26.val[1]))+vaddvq_u8(vcntq_u8(output_cache_26.val[2]))+vaddvq_u8(vcntq_u8(output_cache_26.val[3])));
        ...
        output_cache_27.val[2] = vaddq_u8(output_cache_27.val[2],data1.val[2]);
        output_cache_27.val[3] = vaddq_u8(output_cache_27.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_27.val[0]))+vaddvq_u8(vcntq_u8(output_cache_27.val[1]))+vaddvq_u8(vcntq_u8(output_cache_27.val[2]))+vaddvq_u8(vcntq_u8(output_cache_27.val[3])));
        ...
        output_cache_28.val[2] = vaddq_u8(output_cache_28.val[2],data1.val[2]);
        output_cache_28.val[3] = vaddq_u8(output_cache_28.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_28.val[0]))+vaddvq_u8(vcntq_u8(output_cache_28.val[1]))+vaddvq_u8(vcntq_u8(output_cache_28.val[2]))+vaddvq_u8(vcntq_u8(output_cache_28.val[3])));
        ...
        output_cache_29.val[2] = vaddq_u8(output_cache_29.val[2],data1.val[2]);
        output_cache_29.val[3] = vaddq_u8(output_cache_29.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_29.val[0]))+vaddvq_u8(vcntq_u8(output_cache_29.val[1]))+vaddvq_u8(vcntq_u8(output_cache_29.val[2]))+vaddvq_u8(vcntq_u8(output_cache_29.val[3])));
        ...
        output_cache_30.val[2] = vaddq_u8(output_cache_30.val[2],data1.val[2]);
        output_cache_30.val[3] = vaddq_u8(output_cache_30.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_30.val[0]))+vaddvq_u8(vcntq_u8(output_cache_30.val[1]))+vaddvq_u8(vcntq_u8(output_cache_30.val[2]))+vaddvq_u8(vcntq_u8(output_cache_30.val[3])));
        ...
        output_cache_31.val[2] = vaddq_u8(output_cache_31.val[2],data1.val[2]);
        output_cache_31.val[3] = vaddq_u8(output_cache_31.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_31.val[0]))+vaddvq_u8(vcntq_u8(output_cache_31.val[1]))+vaddvq_u8(vcntq_u8(output_cache_31.val[2]))+vaddvq_u8(vcntq_u8(output_cache_31.val[3])));
        ...
        output_cache_32.val[2] = vaddq_u8(output_cache_32.val[2],data1.val[2]);
        output_cache_32.val[3] = vaddq_u8(output_cache_32.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_32.val[0]))+vaddvq_u8(vcntq_u8(output_cache_32.val[1]))+vaddvq_u8(vcntq_u8(output_cache_32.val[2]))+vaddvq_u8(vcntq_u8(output_cache_32.val[3])));
        ...
        output_cache_33.val[2] = vaddq_u8(output_cache_33.val[2],data1.val[2]);
        output_cache_33.val[3] = vaddq_u8(output_cache_33.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_33.val[0]))+vaddvq_u8(vcntq_u8(output_cache_33.val[1]))+vaddvq_u8(vcntq_u8(output_cache_33.val[2]))+vaddvq_u8(vcntq_u8(output_cache_33.val[3])));
        ...
        output_cache_34.val[2] = vaddq_u8(output_cache_34.val[2],data1.val[2]);
        output_cache_34.val[3] = vaddq_u8(output_cache_34.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_34.val[0]))+vaddvq_u8(vcntq_u8(output_cache_34.val[1]))+vaddvq_u8(vcntq_u8(output_cache_34.val[2]))+vaddvq_u8(vcntq_u8(output_cache_34.val[3])));
        ...
        output_cache_35.val[2] = vaddq_u8(output_cache_35.val[2],data1.val[2]);
        output_cache_35.val[3] = vaddq_u8(output_cache_35.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_35.val[0]))+vaddvq_u8(vcntq_u8(output_cache_35.val[1]))+vaddvq_u8(vcntq_u8(output_cache_35.val[2]))+vaddvq_u8(vcntq_u8(output_cache_35.val[3])));
        ...
        output_cache_36.val[2] = vaddq_u8(output_cache_36.val[2],data1.val[2]);
        output_cache_36.val[3] = vaddq_u8(output_cache_36.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_36.val[0]))+vaddvq_u8(vcntq_u8(output_cache_36.val[1]))+vaddvq_u8(vcntq_u8(output_cache_36.val[2]))+vaddvq_u8(vcntq_u8(output_cache_36.val[3])));
        ...
        output_cache_37.val[2] = vaddq_u8(output_cache_37.val[2],data1.val[2]);
        output_cache_37.val[3] = vaddq_u8(output_cache_37.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_37.val[0]))+vaddvq_u8(vcntq_u8(output_cache_37.val[1]))+vaddvq_u8(vcntq_u8(output_cache_37.val[2]))+vaddvq_u8(vcntq_u8(output_cache_37.val[3])));
        ...
        output_cache_38.val[2] = vaddq_u8(output_cache_38.val[2],data1.val[2]);
        output_cache_38.val[3] = vaddq_u8(output_cache_38.val[3],data1.val[3]);
        outputs[h * out_width * num_filters + w * num_filters + f] += 256 - 2 * (vaddvq_u8(vcntq_u8(output_cache_38.val[0]))+vaddvq_u8(vcntq_u8(output_cache_38.val[1]))+vaddvq_u8(vcntq_u8(output_cache_38.val[2]))+vaddvq_u8(vcntq_u8(output_cache_38.val[3])));
