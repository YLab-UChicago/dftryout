    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                i = 2;
                j = 0;
                data1.val[0] = vmulq_s8(input.val[0],weight_cache_14.val[0]);
                data1.val[1] = vmulq_s8(input.val[1],weight_cache_14.val[1]);
                output_cache_8.val[0] = data1.val[0];
                output_cache_8.val[1] = data1.val[1];
                
                i = 1;
                j = 4;
                data1.val[0] = vmulq_s8(input.val[0],weight_cache_15.val[0]);
                data1.val[1] = vmulq_s8(input.val[1],weight_cache_15.val[1]);
                ...
                i = 1;
                j = 3;
                data1.val[0] = vmulq_s8(input.val[0],weight_cache_16.val[0]);
                data1.val[1] = vmulq_s8(input.val[1],weight_cache_16.val[1]);
                ...
                i = 1;
                j = 2;
                data1.val[0] = vmulq_s8(input.val[0],weight_cache_17.val[0]);
                data1.val[1] = vmulq_s8(input.val[1],weight_cache_17.val[1]);
                ...
                i = 1;
                j = 1;
                data1.val[0] = vmulq_s8(input.val[0],weight_cache_18.val[0]);
                data1.val[1] = vmulq_s8(input.val[1],weight_cache_18.val[1]);
                ...
                i = 1;
                j = 0;
                data1.val[0] = vmulq_s8(input.val[0],weight_cache_19.val[0]);
                data1.val[1] = vmulq_s8(input.val[1],weight_cache_19.val[1]);
                output_cache_12.val[0] = data1.val[0];
                output_cache_12.val[1] = data1.val[1];
                
                i = 0;
                j = 4;
                data1.val[0] = vmulq_s8(input.val[0],weight_cache_20.val[0]);
                data1.val[1] = vmulq_s8(input.val[1],weight_cache_20.val[1]);
                ...
                i = 0;
                j = 3;
                data1.val[0] = vmulq_s8(input.val[0],weight_cache_21.val[0]);
                data1.val[1] = vmulq_s8(input.val[1],weight_cache_21.val[1]);
                ...
                data1.val[0] = vmulq_s8(input.val[0],weight_cache_22.val[0]);
                data1.val[1] = vmulq_s8(input.val[1],weight_cache_22.val[1]);
                
                i = 0;
                j = 1;
                output_h = (h + padding - i) / strides;
                output_w = (w + padding - j) / strides;
                data1.val[0] = vmulq_s8(input.val[0],weight_cache_23.val[0]);
                data1.val[1] = vmulq_s8(input.val[1],weight_cache_23.val[1]);
