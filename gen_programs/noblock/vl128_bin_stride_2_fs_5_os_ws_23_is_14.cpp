    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < out_height; h++) {
            for (int w = 0; w < out_width; w ++) {
                ...
                data1.val[0] = veorq_s64(input_cache_12.val[0],weight_cache_22.val[0]);
                output.val[0] = vaddq_u8(output.val[0],vcntq_u8(data1.val[0]));
                ...
                input_w = w * strides +2 - padding;
                input_cache_13 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1.val[0] = veorq_s64(input_cache_13.val[0],weight_cache_22.val[0]);
                output.val[0] = vaddq_u8(output.val[0],vcntq_u8(data1.val[0]));
                ...
                input_w = w * strides +2 - padding;
                input_cache_14 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1.val[0] = veorq_s64(input_cache_14.val[0],weight_cache_22.val[0]);
                output.val[0] = vaddq_u8(output.val[0],vcntq_u8(data1.val[0]));
