    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                i = 1;
                j = 0;
                output_cache_6 = vmulq_s8(input,weight_cache_11);
                ...
                i = 0;
                j = 0;
                output_cache_9 = vmulq_s8(input,weight_cache_15);
                ...
                i = 2;
                j = 0;
                output_cache_4 = vmulq_s8(input,weight_cache_7);
                ...
                i = 1;
                j = 0;
                output_cache_7 = vmulq_s8(input,weight_cache_11);
                ...
                i = 0;
                j = 0;
                output_cache_10 = vmulq_s8(input,weight_cache_15);
                ...
                i = 2;
                j = 0;
                output_cache_5 = vmulq_s8(input,weight_cache_7);
                ...
                i = 0;
                j = 0;
                output_cache_11 = vmulq_s8(input,weight_cache_15);
