    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (i = 0; i < filter_height - 1; i ++) {
            for (j = 0; j < filter_width; j ++) {
                ...
                outputs[h * out_width * num_filters + w * num_filters + f] += vaddvq_u8(input_cache_26.val[0])+vaddvq_u8(input_cache_26.val[1]);
                ...
                outputs[h * out_width * num_filters + w * num_filters + f] += vaddvq_u8(input_cache_27.val[0])+vaddvq_u8(input_cache_27.val[1]);
