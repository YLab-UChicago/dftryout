    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < out_height; h++) {
            for (int w = 0; w < out_width; w ++) {
                ...
                i = 3;
                j = 1;
                data1 = vmulq_s8(input_cache_10,weight_cache_16);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 2;
                data1 = vmulq_s8(input_cache_11,weight_cache_17);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_11,weight_cache_18);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_9,weight_cache_19);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 0;
                data1 = vmulq_s8(input_cache_12,weight_cache_20);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 1;
                data1 = vmulq_s8(input_cache_13,weight_cache_21);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 2;
                data1 = vmulq_s8(input_cache_14,weight_cache_22);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_14,weight_cache_23);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_7,weight_cache_14);
                output = vaddq_u8(output,data1);
                ...
                i = 3;
                j = 1;
                data1 = vmulq_s8(input_cache_11,weight_cache_16);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 2;
                data1 = vmulq_s8(input_cache_9,weight_cache_17);
                output = vaddq_u8(output,data1);
                ...
                input_w = w * strides +3;
                input_cache_9 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = vmulq_s8(input_cache_9,weight_cache_18);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_10,weight_cache_19);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 0;
                data1 = vmulq_s8(input_cache_13,weight_cache_20);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 1;
                data1 = vmulq_s8(input_cache_14,weight_cache_21);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 2;
                data1 = vmulq_s8(input_cache_12,weight_cache_22);
                output = vaddq_u8(output,data1);
                ...
                input_w = w * strides +3;
                input_cache_12 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = vmulq_s8(input_cache_12,weight_cache_23);
                output = vaddq_u8(output,data1);
                ...
                i = 3;
                j = 1;
                data1 = vmulq_s8(input_cache_9,weight_cache_16);
                output = vaddq_u8(output,data1);
                
                i = 3;
                j = 2;
                data1 = vmulq_s8(input_cache_10,weight_cache_17);
                output = vaddq_u8(output,data1);
                ...
                input_w = w * strides +3;
                input_cache_10 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = vmulq_s8(input_cache_10,weight_cache_18);
                output = vaddq_u8(output,data1);
                ...
                input_w = w * strides +4;
                input_cache_11 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = vmulq_s8(input_cache_11,weight_cache_19);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 0;
                data1 = vmulq_s8(input_cache_14,weight_cache_20);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 1;
                data1 = vmulq_s8(input_cache_12,weight_cache_21);
                output = vaddq_u8(output,data1);
                
                i = 4;
                j = 2;
                data1 = vmulq_s8(input_cache_13,weight_cache_22);
                output = vaddq_u8(output,data1);
                ...
                input_w = w * strides +3;
                input_cache_13 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = vmulq_s8(input_cache_13,weight_cache_23);
                output = vaddq_u8(output,data1);
