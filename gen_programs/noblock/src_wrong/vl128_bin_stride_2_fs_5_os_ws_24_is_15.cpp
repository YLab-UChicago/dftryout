...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        input_cache_0 = vld1q_s64((const int64_t *) &inputs[(0 * width * depth /128 + 0 * 128 /256) * 128 /64]);
        input_cache_1 = vld1q_s64((const int64_t *) &inputs[(1 * width * depth /128 + 1 * 128 /256) * 128 /64]);
        input_cache_2 = vld1q_s64((const int64_t *) &inputs[(2 * width * depth /128 + 2 * 128 /256) * 128 /64]);
        input_cache_3 = vld1q_s64((const int64_t *) &inputs[(3 * width * depth /128 + 3 * 128 /256) * 128 /64]);
        input_cache_4 = vld1q_s64((const int64_t *) &inputs[(4 * width * depth /128 + 4 * 128 /256) * 128 /64]);
        input_cache_5 = vld1q_s64((const int64_t *) &inputs[(5 * width * depth /128 + 5 * 128 /256) * 128 /64]);
        input_cache_6 = vld1q_s64((const int64_t *) &inputs[(6 * width * depth /128 + 6 * 128 /256) * 128 /64]);
        input_cache_7 = vld1q_s64((const int64_t *) &inputs[(7 * width * depth /128 + 7 * 128 /256) * 128 /64]);
        input_cache_8 = vld1q_s64((const int64_t *) &inputs[(8 * width * depth /128 + 8 * 128 /256) * 128 /64]);
        input_cache_9 = vld1q_s64((const int64_t *) &inputs[(9 * width * depth /128 + 9 * 128 /256) * 128 /64]);
        input_cache_10 = vld1q_s64((const int64_t *) &inputs[(10 * width * depth /128 + 10 * 128 /256) * 128 /64]);
        input_cache_11 = vld1q_s64((const int64_t *) &inputs[(11 * width * depth /128 + 11 * 128 /256) * 128 /64]);
        input_cache_12 = vld1q_s64((const int64_t *) &inputs[(12 * width * depth /128 + 12 * 128 /256) * 128 /64]);
        input_cache_13 = vld1q_s64((const int64_t *) &inputs[(13 * width * depth /128 + 13 * 128 /256) * 128 /64]);
        input_cache_14 = vld1q_s64((const int64_t *) &inputs[(14 * width * depth /128 + 14 * 128 /256) * 128 /64]);
        ...
        for (int h = 0; h < out_height; h++) {
            for (int w = 0; w < out_width; w ++) {
                ...
                data1 = veorq_s64(input_cache_3,weight_cache_9);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 0;
                data1 = veorq_s64(input_cache_6,weight_cache_10);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 1;
                data1 = veorq_s64(input_cache_7,weight_cache_11);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 2;
                data1 = veorq_s64(input_cache_8,weight_cache_12);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_8,weight_cache_13);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_6,weight_cache_14);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 3;
                j = 0;
                data1 = veorq_s64(input_cache_9,weight_cache_15);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 3;
                j = 1;
                data1 = veorq_s64(input_cache_10,weight_cache_16);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 3;
                j = 2;
                data1 = veorq_s64(input_cache_11,weight_cache_17);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_11,weight_cache_18);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_9,weight_cache_19);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 4;
                j = 0;
                data1 = veorq_s64(input_cache_12,weight_cache_20);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 4;
                j = 1;
                data1 = veorq_s64(input_cache_13,weight_cache_21);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 4;
                j = 2;
                data1 = veorq_s64(input_cache_14,weight_cache_22);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_14,weight_cache_23);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                i = 1;
                j = 2;
                data1 = veorq_s64(input_cache_3,weight_cache_7);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                input_w = w * strides +3;
                input_cache_3 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = veorq_s64(input_cache_3,weight_cache_8);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                i = 2;
                j = 0;
                data1 = veorq_s64(input_cache_7,weight_cache_10);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 1;
                data1 = veorq_s64(input_cache_8,weight_cache_11);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 2;
                data1 = veorq_s64(input_cache_6,weight_cache_12);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                input_w = w * strides +3;
                input_cache_6 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = veorq_s64(input_cache_6,weight_cache_13);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_7,weight_cache_14);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 3;
                j = 0;
                data1 = veorq_s64(input_cache_10,weight_cache_15);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 3;
                j = 1;
                data1 = veorq_s64(input_cache_11,weight_cache_16);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 3;
                j = 2;
                data1 = veorq_s64(input_cache_9,weight_cache_17);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                input_w = w * strides +3;
                input_cache_9 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = veorq_s64(input_cache_9,weight_cache_18);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                data1 = veorq_s64(input_cache_10,weight_cache_19);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 4;
                j = 0;
                data1 = veorq_s64(input_cache_13,weight_cache_20);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 4;
                j = 1;
                data1 = veorq_s64(input_cache_14,weight_cache_21);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 4;
                j = 2;
                data1 = veorq_s64(input_cache_12,weight_cache_22);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                input_w = w * strides +3;
                input_cache_12 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = veorq_s64(input_cache_12,weight_cache_23);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                i = 1;
                j = 1;
                data1 = veorq_s64(input_cache_3,weight_cache_6);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                i = 2;
                j = 0;
                data1 = veorq_s64(input_cache_8,weight_cache_10);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 1;
                data1 = veorq_s64(input_cache_6,weight_cache_11);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 2;
                j = 2;
                data1 = veorq_s64(input_cache_7,weight_cache_12);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                input_w = w * strides +3;
                input_cache_7 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = veorq_s64(input_cache_7,weight_cache_13);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                input_w = w * strides +4;
                input_cache_8 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = veorq_s64(input_cache_8,weight_cache_14);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 3;
                j = 0;
                data1 = veorq_s64(input_cache_11,weight_cache_15);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 3;
                j = 1;
                data1 = veorq_s64(input_cache_9,weight_cache_16);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 3;
                j = 2;
                data1 = veorq_s64(input_cache_10,weight_cache_17);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                input_w = w * strides +3;
                input_cache_10 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = veorq_s64(input_cache_10,weight_cache_18);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                input_w = w * strides +4;
                input_cache_11 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = veorq_s64(input_cache_11,weight_cache_19);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 4;
                j = 0;
                data1 = veorq_s64(input_cache_14,weight_cache_20);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 4;
                j = 1;
                data1 = veorq_s64(input_cache_12,weight_cache_21);
                output = vaddq_u8(output,vcntq_u8(data1));
                
                i = 4;
                j = 2;
                data1 = veorq_s64(input_cache_13,weight_cache_22);
                output = vaddq_u8(output,vcntq_u8(data1));
                ...
                input_w = w * strides +3;
                input_cache_13 = vld1q_s64((const int64_t *) &inputs[(input_h * width * depth /128 + input_w * depth /128) * depth /64]);
                data1 = veorq_s64(input_cache_13,weight_cache_23);
                output = vaddq_u8(output,vcntq_u8(data1));
