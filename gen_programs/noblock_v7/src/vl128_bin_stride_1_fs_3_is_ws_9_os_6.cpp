    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                i = 2;
                j = 0;
                output_cache_0 = veorq_s64(input,weight_cache_2);
                ...
                i = 1;
                j = 1;
                data1 = veorq_s64(input,weight_cache_4);
                output_cache_3 = vaddq_u8(output_cache_3,data1);
                
                i = 1;
                j = 0;
                output_cache_2 = veorq_s64(input,weight_cache_5);
                ...
                i = 2;
                j = 0;
                output_cache_1 = veorq_s64(input,weight_cache_2);
                ...
                i = 1;
                j = 0;
                output_cache_3 = veorq_s64(input,weight_cache_5);
