...
#Run with "python 121_DenseNet.py <number of trials>"
...
with open('quantized_densenet121.tflite', 'wb') as f:
    f.write(quantized_tflite_model)

# Load TFLite model and allocate tensors
interpreter = tf.lite.Interpreter(model_path='quantized_densenet121.tflite')
...
with open('result.txt', 'w') as file:
    ...
    total_time /= num_runs
    result_str = f"Average execution time for 8bit-quantized DenseNet-121: {total_time:.4f} ms\n{num_runs} trials completed"
    print(result_str)
