...
# Run with "python 16_VGG.py <number of trials>"
...
interpreter = tf.lite.Interpreter(model_path='quantized_vgg16.tflite')
...
with open('result.txt', 'w') as file:
    ...
    total_time /= num_runs
    result_str = f"Average execution time for 8bit-quantized VGG-16: {total_time:.4f} ms\n{num_runs} trials completed"
    print(result_str)
