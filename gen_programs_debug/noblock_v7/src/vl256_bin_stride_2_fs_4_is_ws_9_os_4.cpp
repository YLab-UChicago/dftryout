    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                i = 2;
                j = 1;
                output_cache_2.val[0] = veorq_s64(input.val[0],weight_cache_6.val[0]);
                output_cache_2.val[1] = veorq_s64(input.val[1],weight_cache_6.val[1]);
                
                i = 2;
                j = 0;
                output_cache_3.val[0] = veorq_s64(input.val[0],weight_cache_7.val[0]);
                output_cache_3.val[1] = veorq_s64(input.val[1],weight_cache_7.val[1]);
