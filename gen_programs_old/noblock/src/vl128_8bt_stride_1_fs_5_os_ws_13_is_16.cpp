...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        input_cache_15 = vld1q_s64((const int64_t *) &inputs[(15 * width * depth /128 + 15 * 128 /256) * 128 /64]);
        ...
        for (int h = 0; h < out_height; h++) {
            for (int w = 0; w < out_width; w ++) {
                ...
                i = 1;
                j = 0;
                data1 = vmulq_s8(input_cache_4,weight_cache_5);
                output = vaddq_u8(output,data1);
                
                i = 1;
                j = 1;
                data1 = vmulq_s8(input_cache_5,weight_cache_6);
                output = vaddq_u8(output,data1);
                
                i = 1;
                j = 2;
                data1 = vmulq_s8(input_cache_6,weight_cache_7);
                output = vaddq_u8(output,data1);
                
                i = 1;
                j = 3;
                data1 = vmulq_s8(input_cache_7,weight_cache_8);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_4,weight_cache_9);
                output = vaddq_u8(output,data1);
                
                i = 2;
                j = 0;
                data1 = vmulq_s8(input_cache_8,weight_cache_10);
                output = vaddq_u8(output,data1);
                
                i = 2;
                j = 1;
                data1 = vmulq_s8(input_cache_9,weight_cache_11);
                output = vaddq_u8(output,data1);
                
                i = 2;
                j = 2;
                data1 = vmulq_s8(input_cache_10,weight_cache_12);
                output = vaddq_u8(output,data1);
                ...
                i = 1;
                j = 0;
                data1 = vmulq_s8(input_cache_5,weight_cache_5);
                output = vaddq_u8(output,data1);
                
                i = 1;
                j = 1;
                data1 = vmulq_s8(input_cache_6,weight_cache_6);
                output = vaddq_u8(output,data1);
                
                i = 1;
                j = 2;
                data1 = vmulq_s8(input_cache_7,weight_cache_7);
                output = vaddq_u8(output,data1);
                ...
                i = 2;
                j = 0;
                data1 = vmulq_s8(input_cache_9,weight_cache_10);
                output = vaddq_u8(output,data1);
                
                i = 2;
                j = 1;
                data1 = vmulq_s8(input_cache_10,weight_cache_11);
                output = vaddq_u8(output,data1);
                
                i = 2;
                j = 2;
                data1 = vmulq_s8(input_cache_11,weight_cache_12);
                output = vaddq_u8(output,data1);
                ...
                i = 1;
                j = 0;
                data1 = vmulq_s8(input_cache_6,weight_cache_5);
                output = vaddq_u8(output,data1);
                
                i = 1;
                j = 1;
                data1 = vmulq_s8(input_cache_7,weight_cache_6);
                output = vaddq_u8(output,data1);
                
                i = 1;
                j = 2;
                data1 = vmulq_s8(input_cache_4,weight_cache_7);
                output = vaddq_u8(output,data1);
                
                i = 1;
                j = 3;
                data1 = vmulq_s8(input_cache_5,weight_cache_8);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_6,weight_cache_9);
                output = vaddq_u8(output,data1);
                
                i = 2;
                j = 0;
                data1 = vmulq_s8(input_cache_10,weight_cache_10);
                output = vaddq_u8(output,data1);
                
                i = 2;
                j = 1;
                data1 = vmulq_s8(input_cache_11,weight_cache_11);
                output = vaddq_u8(output,data1);
                
                i = 2;
                j = 2;
                data1 = vmulq_s8(input_cache_8,weight_cache_12);
                output = vaddq_u8(output,data1);
                ...
                i = 1;
                j = 0;
                data1 = vmulq_s8(input_cache_7,weight_cache_5);
                output = vaddq_u8(output,data1);
                
                i = 1;
                j = 1;
                data1 = vmulq_s8(input_cache_4,weight_cache_6);
                output = vaddq_u8(output,data1);
                
                i = 1;
                j = 2;
                data1 = vmulq_s8(input_cache_5,weight_cache_7);
                output = vaddq_u8(output,data1);
                
                i = 1;
                j = 3;
                data1 = vmulq_s8(input_cache_6,weight_cache_8);
                output = vaddq_u8(output,data1);
                ...
                data1 = vmulq_s8(input_cache_7,weight_cache_9);
                output = vaddq_u8(output,data1);
                
                i = 2;
                j = 0;
                data1 = vmulq_s8(input_cache_11,weight_cache_10);
                output = vaddq_u8(output,data1);
                
                i = 2;
                j = 1;
                data1 = vmulq_s8(input_cache_8,weight_cache_11);
                output = vaddq_u8(output,data1);
                
                i = 2;
                j = 2;
                data1 = vmulq_s8(input_cache_9,weight_cache_12);
                output = vaddq_u8(output,data1);
