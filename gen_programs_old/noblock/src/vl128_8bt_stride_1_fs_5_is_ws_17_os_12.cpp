    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                i = 2;
                j = 0;
                output_cache_8 = vmulq_s8(input,weight_cache_14);
                ...
                i = 2;
                j = 0;
                output_cache_9 = vmulq_s8(input,weight_cache_14);
                ...
                i = 2;
                j = 0;
                output_cache_10 = vmulq_s8(input,weight_cache_14);
                ...
                i = 2;
                j = 0;
                output_cache_11 = vmulq_s8(input,weight_cache_14);
