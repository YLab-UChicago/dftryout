...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
            ...
            for (j = 0; j < filter_width; j ++) {
                ...
                for (h = 0; h < out_height; h++) {
                    for (w = 29; w < out_width; w++) {
                        ...
                        data1 = vmulq_s8(data1,data2);
                        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(data1);
                    }
                }
            }
        }
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_0 = vaddq_u8(output_cache_0,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_0);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_1 = vaddq_u8(output_cache_1,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_1);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_2 = vaddq_u8(output_cache_2,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_2);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_3 = vaddq_u8(output_cache_3,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_3);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_4 = vaddq_u8(output_cache_4,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_4);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_5 = vaddq_u8(output_cache_5,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_5);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_6 = vaddq_u8(output_cache_6,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_6);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_7 = vaddq_u8(output_cache_7,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_7);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_8 = vaddq_u8(output_cache_8,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_8);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_9 = vaddq_u8(output_cache_9,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_9);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_10 = vaddq_u8(output_cache_10,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_10);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_11 = vaddq_u8(output_cache_11,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_11);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_12 = vaddq_u8(output_cache_12,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_12);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_13 = vaddq_u8(output_cache_13,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_13);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_14 = vaddq_u8(output_cache_14,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_14);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_15 = vaddq_u8(output_cache_15,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_15);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_16 = vaddq_u8(output_cache_16,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_16);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_17 = vaddq_u8(output_cache_17,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_17);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_18 = vaddq_u8(output_cache_18,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_18);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_19 = vaddq_u8(output_cache_19,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_19);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_20 = vaddq_u8(output_cache_20,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_20);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_21 = vaddq_u8(output_cache_21,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_21);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_22 = vaddq_u8(output_cache_22,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_22);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_23 = vaddq_u8(output_cache_23,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_23);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_24 = vaddq_u8(output_cache_24,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_24);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_25 = vaddq_u8(output_cache_25,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_25);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_26 = vaddq_u8(output_cache_26,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_26);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_27 = vaddq_u8(output_cache_27,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_27);
        ...
        data1 = vmulq_s8(data1,data2);
        output_cache_28 = vaddq_u8(output_cache_28,data1);
        outputs[f / 64 * out_height * out_width + h * out_width * 64 + w * 64 + f % 64] += vaddvq_u8(output_cache_28);
