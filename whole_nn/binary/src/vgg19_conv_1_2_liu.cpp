    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        for (i = 0; i < filter_height - 1; i ++) {
            for (j = 0; j < filter_width; j ++) {
                h = 0;
                w = 0;
                data2 = vld1_s64((const int64_t *) & filters[(f * filter_height * filter_width + i * filter_width + j)*64/64]);
                
                
                input_h = h * strides + i;
                input_w = w * strides + j;
                data1 = vld1_s64((const int64_t*)& filters[(f * filter_height * filter_width + i * filter_width + j)*64/64]);
                ...
                for (h = 0; h < out_height; h++) {
                    for (w = 29; w < out_width; w++) {
                        input_h = h * strides + i;
                        input_w = w * strides + j;
                        data1 = vld1_s64((const int64_t *) &inputs[(input_h * width * depth /64+ input_w * depth /64) * 64 /64]);
                        data1 = veor_s64(data1,data2);
