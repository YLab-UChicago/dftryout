...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        ...
        input_cache_6 = vld1q_s64_x2((const int64_t *) &inputs[((0-padding) * width * depth /256 + (6-padding) * depth /256) * depth /64]);
        input_cache_7 = vld1q_s64_x2((const int64_t *) &inputs[((0-padding) * width * depth /256 + (7-padding) * depth /256) * depth /64]);
        ...
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                sum_block += 256 - 2 * (vaddvq_u8(vcntq_u8(input_cache_7.val[0]))+vaddvq_u8(vcntq_u8(input_cache_7.val[1])));
