...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        int64x2x2_t output_cache_0.val[0]=vdupq_n_u64(0);
        int64x2x2_t output_cache_0.val[1]=vdupq_n_u64(0);
        int64x2x2_t output_cache_1.val[0]=vdupq_n_u64(0);
        int64x2x2_t output_cache_1.val[1]=vdupq_n_u64(0);
        int64x2x2_t output_cache_2.val[0]=vdupq_n_u64(0);
        int64x2x2_t output_cache_2.val[1]=vdupq_n_u64(0);
        int64x2x2_t output_cache_3.val[0]=vdupq_n_u64(0);
        int64x2x2_t output_cache_3.val[1]=vdupq_n_u64(0);
        int64x2x2_t output_cache_4.val[0]=vdupq_n_u64(0);
