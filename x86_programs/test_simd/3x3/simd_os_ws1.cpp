...
{
    FILE *pFile = fopen("durations/simd_os_ws1.txt", "a");
    int height;
    int width;
    int depth;
    int filter_height;
    ...
    for (int f = 0; f < num_filters; f++)
    {
        ...
        for (int h = 0; h < out_height; h++)
        {
            for (int w = 0; w < out_width; w++)
            {
                ...
                data_to_process = inputs[input_h * width * depth + input_w * depth];
                filter = filters[f * filter_height * filter_width * depth + 2];
                ...
                input_w = w * strides + 0 - padding;
                data_to_process = inputs[input_h * width * depth + input_w * depth];
                filter = filters[f * filter_height * filter_width * depth + 3];
                data_to_process = _mm256_xor_si256(data_to_process, filter);
                data_to_process = _mm256_popcnt_epi64(data_to_process);
                sum_block += 256 - 2 * (data_to_process[0] + data_to_process[1] + data_to_process[2] + data_to_process[3]);
                ...
                input_w = w * strides + 1 - padding;
                data_to_process = inputs[input_h * width * depth + input_w * depth];
                filter = filters[f * filter_height * filter_width * depth + 4];
                data_to_process = _mm256_xor_si256(data_to_process, filter);
                data_to_process = _mm256_popcnt_epi64(data_to_process);
                sum_block += 256 - 2 * (data_to_process[0] + data_to_process[1] + data_to_process[2] + data_to_process[3]);
                ...
                input_w = w * strides + 2 - padding;
                data_to_process = inputs[input_h * width * depth + input_w * depth];
                filter = filters[f * filter_height * filter_width * depth + 5];
                data_to_process = _mm256_xor_si256(data_to_process, filter);
                data_to_process = _mm256_popcnt_epi64(data_to_process);
                sum_block += 256 - 2 * (data_to_process[0] + data_to_process[1] + data_to_process[2] + data_to_process[3]);
                ...
                input_w = w * strides + 0 - padding;
                data_to_process = inputs[input_h * width * depth + input_w * depth];
                filter = filters[f * filter_height * filter_width * depth + 6];
                data_to_process = _mm256_xor_si256(data_to_process, filter);
                data_to_process = _mm256_popcnt_epi64(data_to_process);
                sum_block += 256 - 2 * (data_to_process[0] + data_to_process[1] + data_to_process[2] + data_to_process[3]);
                ...
                input_w = w * strides + 1 - padding;
                data_to_process = inputs[input_h * width * depth + input_w * depth];
                filter = filters[f * filter_height * filter_width * depth + 7];
                data_to_process = _mm256_xor_si256(data_to_process, filter);
                data_to_process = _mm256_popcnt_epi64(data_to_process);
                sum_block += 256 - 2 * (data_to_process[0] + data_to_process[1] + data_to_process[2] + data_to_process[3]);
