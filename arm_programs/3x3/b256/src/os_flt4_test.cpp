...
int main (int argc, char *argv[]) {
    ...
    for (int f = 0; f < num_filters; f++) {
        printf("0");
        fflush(stdout);
        input_cache_0 = vld1q_s64((const int64_t *) &inputs[(0 * width * depth /128 + 0 * depth /128) * 128 /64]);
        input_cache_1 = vld1q_s64((const int64_t *) &inputs[(1 * width * depth /128 + 1 * depth /128) * 128 /64]);
        input_cache_2 = vld1q_s64((const int64_t *) &inputs[(2 * width * depth /128 + 2 * depth /128) * 128 /64]);
