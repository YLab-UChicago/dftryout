...
int main (int argc, char *argv[]) {
    FILE* pFile = fopen("out/durations/1_256_os_ws4_is3.txt", "a");
    int height;
    int width;
    int depth;
    int filter_height;
    ...
    uint64x2x2_t data1;
    uint64x2x2_t data2;
    uint64x2x2_t input_cache_0;
    uint64x2x2_t input_cache_1;
    uint64x2x2_t input_cache_2;
    
    uint64x2x2_t weight_cache_0;
    ...
    for (int f = 0; f < num_filters; f++) {
        input_cache_0 = vld1q_u64_x2((const uint64_t *) &inputs[((0-padding) * width * depth /256 + (0-padding) * depth /256) * depth /64]);
        input_cache_1 = vld1q_u64_x2((const uint64_t *) &inputs[((0-padding) * width * depth /256 + (1-padding) * depth /256) * depth /64]);
        input_cache_2 = vld1q_u64_x2((const uint64_t *) &inputs[((0-padding) * width * depth /256 + (2-padding) * depth /256) * depth /64]);
        weight_cache_0 = vld1q_u64_x2((const uint64_t*) &filters[(f * filter_height * filter_width +0)]);
        weight_cache_1 = vld1q_u64_x2((const uint64_t*) &filters[(f * filter_height * filter_width +1)]);
        weight_cache_2 = vld1q_u64_x2((const uint64_t*) &filters[(f * filter_height * filter_width +2)]);
        weight_cache_3 = vld1q_u64_x2((const uint64_t*) &filters[(f * filter_height * filter_width +3)]);
        for (int h = 0; h < height; h++) {
            for (int w = 0; w < width; w ++) {
                ...
                data1.val[0] = veorq_u64(input_cache_0.val[0],weight_cache_0.val[0]);
                data1.val[1] = veorq_u64(input_cache_0.val[1],weight_cache_0.val[1]);
