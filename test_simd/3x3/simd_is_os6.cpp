...
{
    FILE *pFile = fopen("durations/simd_is_os6.txt", "a");
    int height;
    int width;
    int depth;
    int filter_height;
    ...
    for (int f = 0; f < num_filters; f++)
    {
        ...
        output_cache_6 = _mm256_setr_epi64x(0, 0, 0, 0);
        ...
        for (int h = 0; h < height; h++)
        {
            for (int w = 0; w < width; w++)
            {
                ...
                data_to_process = _mm256_xor_si256(input, filter);
                data_to_process = _mm256_popcnt_epi64(data_to_process);
                output_cache_1 = output_cache_4 + data_to_process;
                ...
                filter = filters[f * filter_height * filter_width * depth + i * filter_width + j];
                data_to_process = _mm256_xor_si256(input, filter);
                output_cache_4 = _mm256_popcnt_epi64(data_to_process);
                ...
                data_to_process = _mm256_xor_si256(input, filter);
                data_to_process = _mm256_popcnt_epi64(data_to_process);
                output_cache_2 += output_cache_5 + data_to_process;
                ...
                filter = filters[f * filter_height * filter_width * depth + i * filter_width + j];
                data_to_process = _mm256_xor_si256(input, filter);
                output_cache_5 = _mm256_popcnt_epi64(data_to_process);
                ...
                data_to_process = _mm256_xor_si256(input, filter);
                data_to_process = _mm256_popcnt_epi64(data_to_process);
                output_cache_3 += output_cache_6 + data_to_process;
                ...
                filter = filters[f * filter_height * filter_width * depth + i * filter_width + j];
                data_to_process = _mm256_xor_si256(input, filter);
                output_cache_6 = _mm256_popcnt_epi64(data_to_process);
            }
        }
    }
