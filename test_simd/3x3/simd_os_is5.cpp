...
{
    FILE *pFile = fopen("durations/simd_os_is5.txt", "a");
    int height;
    int width;
    int depth;
    int filter_height;
    ...
    for (int f = 0; f < num_filters; f++)
    {
        ...
        for (int h = 0; h < out_height; h++)
        {
            for (int w = 0; w < out_width; w++)
            {
                ...
                input_cache_4 = data_to_process = inputs[input_h * width * depth + input_w * depth];
                ...
                input_h = h * strides + 1 - padding;
                input_w = w * strides + 2 - padding;
                input_cache_5 = data_to_process = inputs[input_h * width * depth + input_w * depth];
                ...
                input_h = h * strides + 2 - padding;
                input_w = w * strides + 1 - padding;
                input_cache_3 = data_to_process = inputs[input_h * width * depth + input_w * depth];
